...
Ipv6InterfaceContainer MmWavePointToPointEpcHelper::AssignUeIpv6Address(NetDeviceContainer ueDevices)
{
...
Ipv6Address MmWavePointToPointEpcHelper::GetUeDefaultGatewayAddress6()
{
    // return the address of the tun device
